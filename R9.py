...
def comparaison(noir, tab, Pmax, dim, Id):			#paramètres à comparer pour grosse vs petite
	...
	plt.scatter(tab[:,1], np.log(Id[:]), marker='.', color='k')
...
plt.scatter(tabg1[50:,1], tabg1[50:,0], marker = '.')
...
ax2 = ax1.twinx()
ax1.scatter(np.array([11, 15, 25, 100]), np.array([valsps1_1[0], valsps1_2[0], valsps1_3[0], valsps1_4[0]]), label = 'Icc')
ax2.scatter(np.array([11, 15, 25, 100]), np.array([valsps1_1[4], valsps1_2[4], valsps1_3[4], valsps1_4[4]]), label = 'Pmax')
...
fig, ax1 = plt.subplots()
ax2 = ax1.twinx()
ax1.scatter(np.array([1, 2, 3, 4]), np.array([valsps1_1[0], valsps2_1[0], valsps3_1[0], valsps4_1[0]]), label = 'Icc en série')
ax1.scatter(np.array([1, 2, 3, 4]), np.array([valsps1_1[0], valspp2_1[0], valspp3_1[0], valspp4_1[0]]), label = 'Icc en parallèle')
ax2.scatter(np.array([1, 2, 3, 4]), np.array([valsps1_1[4], valsps2_1[4], valsps3_1[4], valsps4_1[4]]), label = 'Pmax en série')
ax2.scatter(np.array([1, 2, 3, 4]), np.array([valsps1_1[4], valspp2_1[4], valspp3_1[4], valspp4_1[4]]), label = 'Pmax en parllèle')
ax1.set_xlabel("Intensité d'illumination (W)")
ax1.set_ylabel('Courant (A)')
ax2.set_ylabel('Puissance (W)')
plt.legend(loc='best')
